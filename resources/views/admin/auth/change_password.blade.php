    ...
    <input type="hidden" name="verify_token" value="{{$token}}">
        ...
        <span class="input input--madoka">
            ...
            <label class="input__label input__label--madoka" for="input-31">
                ...
                <span class="input__label-content input__label-content--madoka" style="color: rgb(221, 221, 221)">Mật khẩu mới</span>
            </label>
        </span>
    </div>
    ...
    <div class="input-password">
        <span class="input input--madoka">
            ...
            <label class="input__label input__label--madoka" for="input-32">
                ...
                <span class="input__label-content input__label-content--madoka" style="color: rgb(221, 221, 221)">Nhập lại mật khẩu</span>
            </label>
        </span>
    </div>
    <div id="password_confirm_error" class="p_error" style="color:red"></div>
    <div class="submit-button">
        <span class="input input--madoka">
            <input class="input__field input__field--madoka" type="submit" value="Xác nhận" id="input-33" />
...
<script>
    $('#input-33').on('click',function(){
        ...
        var password=$('#input-31').val();
        var password_confirm=$('#input-32').val();
        ...
        if(password.lenght==0){
            ...
            $.ajax({
                ...
                data: {password:password,_token:_token,password_confirm:password_confirm,verify_token:verify_token},
                dataType: "json",
