...
<body>
    <section class="content bgcolor-4">
        <h1 class="login">NHẬP EMAIL CỦA BẠN</h1>
        ...
        <span class="input input--madoka">
            ...
            <label class="input__label input__label--madoka" for="input-31">
                ...
                <span class="input__label-content input__label-content--madoka" style="color: rgb(221, 221, 221)">Nhập email</span>
            </label>
...
<script>
    $('#input-33').on('click',function(){
        ...
        if(user_email.lenght==0){
            $('#email_error').html('Email không được trống');
        }else{
            $.ajax({
                type: "POST",
                url: "{{url('admin/auth/forget_password')}}",
                data: {user_email:user_email,_token:_token},
                dataType: "json",
